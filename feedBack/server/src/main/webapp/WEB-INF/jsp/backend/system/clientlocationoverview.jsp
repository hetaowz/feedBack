...
<div class="widget">
    <div class="title"><img src="${pageContext.request.contextPath}/images/icons/dark/frames.png" alt="" class="titleIcon"/><h6>用户定位信息</h6>
    </div>
    <table width="100%" cellpadding="0" cellspacing="0" class="sTable">
        ...
        <c:forEach items="${clientLocationDTOs}" var="clientLocation">
            ...
            <tr class="${color}" onmouseover="this.className='over'" onmouseout="this.className='${color}'">
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/backend/clientlocationmap.html?lon=${clientLocation.lon}&&lat=${clientLocation.lat}" onclick=""><button class="editBtn bluewB">查看</button></a>
                </td>
