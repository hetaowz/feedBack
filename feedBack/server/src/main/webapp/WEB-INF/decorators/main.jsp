...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/plugins/charts/jquery.flot.orderBars.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/plugins/charts/jquery.flot.pie.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/plugins/charts/jquery.flot.resize.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/s/plugins/uploader/jquery.plupload.queue.js"></script>
...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        ...
        <li class="forms"><a href="${pageContext.request.contextPath}/backend/clientuserfeedbackoverview.html" title="" class="exp"><span>用户反馈</span><strong>2</strong></a>
            <ul class="sub">
                <li><a href="${pageContext.request.contextPath}/backend/clientuserfeedbackoverview.html" title="">反馈信息</a></li>
                <li><a href="${pageContext.request.contextPath}/backend/clientuserfeedback.html" title="">反馈统计</a></li>
            </ul>
        </li>
        <li class="ui"><a href="${pageContext.request.contextPath}/backend/clientusercollector.html" title=""><span>收视统计</span></a></li>
        <li class="tables"><a href="${pageContext.request.contextPath}/backend/clientlocationoverview.html" title="" class="exp"><span>用户定位</span></a> </li>
    
        <li class="errors"><a href="${pageContext.request.contextPath}/backend/useroverview.html" title="" class="exp"><span>系统设置</span><strong>3</strong></a>
            <ul class="sub">
                ...
                <li><a href="${pageContext.request.contextPath}/backend/tvchannelinfooverview.html" title="">频道管理</a></li>
            </ul>
        </li>
    </ul>
</div>
